...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center blue-text text-darken-1">¡Sopa de Señas!</h1>
        <div class="row center">
          <br><br>
        <h2 class="header center grey-text text-darken-1">¡Vamos con un juego!</h2>
        </div>
      </div>
    </div>
    <!-- Fondo 1-->
    <div class="parallax"><img src="Fondo/Chily wily why.jpg" alt="Unsplashed background img 1"></div>
  </div>
  ...
  <section class="JUEGO">
      ...
      <div id='Palabras'></div>
        <script>
          var words = ['tio','papá','mamá','abuela','hermano','abuelo'];
        ...
        <br>
        <br>
        <img src="imagenes/sopita/m.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/m.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/mama.png" alt="" width="70" height="70">
        <br>
        <img src="imagenes/sopita/p.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/p.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/papa.png" alt="" width="70" height="70">
        <br>
        <img src="imagenes/sopita/t.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/i.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/o.jpg" alt="" width="70" height="70">
        <img src="imagenes/tio.png" alt="" width="70" height="70">
        <br>
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/b.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/u.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/e.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/l.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/abuela.png" alt="" width="70" height="70">
        <br>
        <img src="imagenes/sopita/a.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/b.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/u.jpg" alt="" width="70" height="70">
        ...
        <img src="imagenes/sopita/l.jpg" alt="" width="70" height="70">
        <img src="imagenes/sopita/o.jpg" alt="" width="70" height="70">
        <img src="imagenes/abuelo.png" alt="" width="70" height="70">
        <br>
        <img src="imagenes/sopita/h.jpg" alt="" width="60" height="60">
        <img src="imagenes/sopita/e.jpg" alt="" width="60" height="60">
        <img src="imagenes/sopita/r.jpg" alt="" width="60" height="60">
        <img src="imagenes/sopita/m.jpg" alt="" width="60" height="60">
        <img src="imagenes/sopita/a.jpg" alt="" width="60" height="60">
        <img src="imagenes/sopita/n.jpg" alt="" width="60" height="60">
        <img src="imagenes/sopita/o.jpg" alt="" width="60" height="60">
        <img src="imagenes/hermanos.png" alt="" width="60" height="60">
        <br>
    </div>
    </section>
